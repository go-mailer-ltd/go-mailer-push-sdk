...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ScrollView rootView,
      ...
      @NonNull MaterialButton btnTestCompleteFlow, @NonNull MaterialButton btnTrackEvents,
      @NonNull TextInputEditText etEmail, @NonNull TextView tvEventStatus,
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ScrollView) rootView, btnRequestPermission, btnSendUserData,
          btnTestCompleteFlow, btnTrackEvents, etEmail, tvEventStatus, tvNotificationStatus,
          tvUserStatus);
    }
